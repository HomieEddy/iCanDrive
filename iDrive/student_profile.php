							...
							<tr>
								...
								<td> 
									<form method='POST'>
										...
										<input type='Submit' name='option' value='Rent Car' /><br>
										<input type='Submit' name='option' value='Quiz' 	/><br>
										<input type='Submit' name='option' value='Schedule' />
									</form>
								</td>
							</tr>
						</table>
						<?php
							if(isset($_POST['option']) && $_POST['option'] == 'Messages'){
